    ...
    >
      <Card.Section pos={'relative'} className='cursor-pointer overflow-hidden' h={'50%'}>
        ...
        <Box
          ...
          h='100%'
          w='100%'
          className={`visible flex items-start justify-end bg-[rgba(0,0,0,0.2)] transition-all duration-200 ease-in-out sm:group-hover:visible md:items-center md:justify-center lg:invisible`}
        >
          <Group
            gap={5}
